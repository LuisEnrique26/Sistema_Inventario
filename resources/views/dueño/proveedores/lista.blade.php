                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a type="button" class="btn btn-primary" href="{{ route('dueñoformularioProveedor') }}">Agregar Proveedor</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($proveedores as $proveedor)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('dueñoeditarProveedor', ['id' => $proveedor->id_proveedor]) }}"><button
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a
                                                        href="{{ route('dueñoeliminarProveedor', ['id' => $proveedor->id_proveedor]) }}"><button
