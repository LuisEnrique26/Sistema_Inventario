            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($entradas as $entrada)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('editarEntrada', ['id' => $entrada->id_producto_proveedor]) }}"><button
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a
                                                        href="{{ route('eliminarProducto', ['id' => $entrada->id_producto_proveedor]) }}"><button
                        ...
                        <a href="{{ route('listaEntradas') }}" class="btn btn-secondary rounded-pill" type="button">Ir a lista</a>
                    </div>
                </div>
