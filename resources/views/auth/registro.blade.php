                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ route('validar_registro') }}"
                                        method="POST">
                                        @csrf
                                        <div class="col-12">
                                            <label for="yourName" class="form-label">Tu nombre_usuario</label>
                                            <input type="text" name="nombre_usuario" class="form-control"
                                                id="yourName" value="{{ old('nombre_usuario') }}" required>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <div class="invalid-feedback">Debes estar de acuerdo para poder registrarte</div>
                                            </div>
                                        </div>
                                        <div class="col-12">
