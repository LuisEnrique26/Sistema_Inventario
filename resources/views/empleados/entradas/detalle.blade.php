                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a type="button" class="btn btn-primary" href="{{ route('empleadoformularioEntrada') }}">Entrada de Productos</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($entradas as $entrada)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('empleadoeditarEntrada', ['id' => $entrada->id_producto_proveedor]) }}"><button
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a
                                                        href="{{ route('empleadoeliminarProducto', ['id' => $entrada->id_producto_proveedor]) }}"><button
                        ...
                        <a href="{{ route('empleadolistaEntradas') }}" class="btn btn-secondary rounded-pill" type="button">Ir a lista</a>
                    </div>
                </div>
