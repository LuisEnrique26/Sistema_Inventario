                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a type="button" class="btn btn-primary" href="{{ route('empleadoformularioVenta') }}">Generar Venta</a>
                        </div>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a
                                                        href="{{ route('empleadoeliminarVenta', ['id' => $ventaD->id_venta_detalle, 'idV' => $ventaD->id_venta]) }}"><button
                        ...
                        <a href="{{ route('empleadolistaVentas') }}" class="btn btn-secondary rounded-pill" type="button">Ir a lista</a>
                    </div>
                </div>
