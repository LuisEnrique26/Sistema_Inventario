                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            <a type="button" class="btn btn-primary" href="{{ route('empleadoformularioProducto') }}">Agregar Producto</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($productos as $producto)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('empleadomostrarProducto', ['id' => $producto->id_producto]) }}"><button
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a
                                                        href="{{ route('empleadoeliminarProducto', ['id' => $producto->id_producto]) }}"><button
